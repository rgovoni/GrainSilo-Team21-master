...
#define cell_l   0.2 //set cell dimension
#define MAX_CELLS 260 //max cells according to cell_l
...
//add in def of cell and cell list
typedef struct
{
  Vec2     coord; //x and y coordinates of cell
  int      name; //ID for cell
} Cell;
...
//-----------------------------------------------------------------------------
//  pre:    -
//  post:   initializes cells with ids and empty contents for particle matching
//  return: -
...
//-----------------------------------------------------------------------------
//  pre:    -
//  post:   match particles to the cells!
//  return: -
void match_cell
